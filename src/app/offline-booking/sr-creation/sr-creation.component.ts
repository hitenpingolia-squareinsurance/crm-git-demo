...
export class SrCreationComponent implements OnInit {
  ...
  this.minDate1 = new Date(today);
  // in past sr more then not selected
  this.minDate1.setDate(this.minDate1.getDate() - 45);
  this.maxDate1 = new Date(today);
  this.maxDate1.setDate(this.maxDate1.getDate() + 30);
