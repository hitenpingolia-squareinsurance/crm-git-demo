...
export class CreateTicketComponent implements OnInit {
  ...
  onChangeFormWise(e) {
    ...
    const Select_Payout = this.AddForm.get("Select_Payout");
    ...
    if( Values == "Payout/Commision Related-Query"){
      this.AddForm.get("Select_Payout").setValidators([Validators.required]);
      this.AddForm.get("Remark").setValidators(null);
    }else{
      this.AddForm.get("Select_Payout").setValidators(null);
      this.AddForm.get("Remark").setValidators([Validators.required]);
    }
    this.AddForm.get("Select_Payout").updateValueAndValidity();
    this.AddForm.get("Remark").updateValueAndValidity();
  ...
  SearchOfflineQuoteIds(e, Type, Value) {
    ...
    PayoutAr(e) {
      ...
      if (e.Id == 0) {
        ...
        this.AddForm.get("Remark_1").setValidators( [Validators.required]);
        this.AddForm.get("Remark_1").updateValueAndValidity();
      }
      if (e.Id == 1) {
        this.payout_diff = true;
        this.AddForm.get("Remark_2").setValidators( [Validators.required]);
        this.AddForm.get("Remark_2").updateValueAndValidity();
      }
      if (e.Id == 2) {
        this.payout_not_received = true;
        this.AddForm.get("Remark_3").setValidators( [Validators.required]);
