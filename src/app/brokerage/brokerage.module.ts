...
import { SrHoldReportComponent } from './sr-hold-report/sr-hold-report.component';
...
@NgModule({
  declarations: [
    ...
    SrCustomUpdationReportComponent,EarlyPayoutFilesComponent,ViewInvoiceComponent,InvoiceDiscriptionMasterComponent, GenerateInvoiceNewComponent,SrHoldReportComponent
  ],
