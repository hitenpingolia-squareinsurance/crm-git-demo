...
export class CommonFilterComponent implements OnInit {
  ...
  SearchFormData() {
    ...
    if (this.SearchForm.invalid) {
      ...
      var ConvertDateOrDateRange = fields["convert_date_range"];
      ...
      var ConvertFromDate, ConvertToDate;
      if (ConvertDateOrDateRange) {
        ConvertFromDate = ConvertDateOrDateRange[0];
        ConvertToDate = ConvertDateOrDateRange[1];
      }
      ...
      const post = {
        ...
        date_from: FromDate,
        date_to: ToDate,
        convert_date_from: ConvertFromDate,
        convert_date_to: ConvertToDate,
