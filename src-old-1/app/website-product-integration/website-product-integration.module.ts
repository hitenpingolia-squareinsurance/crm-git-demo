...
import {AddAddonComponent} from './PA/add-addon-desc/add-addon/add-addon.component';
import {EditAddonComponent} from './PA/add-addon-desc/edit-addon/edit-addon.component';
import {ViewAddonComponent} from './PA/add-addon-desc/view-addon/view-addon.component';
...
@NgModule({
  declarations: [ViewPlanBenifitComponent, ViewBourcherHealthComponent, ViewHospitalListComponent,
    AddPlanBenifitComponent, AddHospitalListComponent,AddAddonComponent,EditAddonComponent,ViewAddonComponent,
  ...
  entryComponents: [AddPlanBenifitComponent, AddHospitalListComponent, AddBourcherHealthComponent, EditPlanBenefitComponent, AddHighlightComponent, EditHighlightComponent, AddYoutubeComponent, EditYoutubeComponent,AddAddonComponent,EditAddonComponent],
