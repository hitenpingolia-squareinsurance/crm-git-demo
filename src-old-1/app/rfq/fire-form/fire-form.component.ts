...
export class FireFormComponent implements OnInit {
  ...
  toggleInputVisibility(event: any) {
    ...
    this.FireForm.get("building_structure").value();
    this.FireForm.get("plant_machinery").value();
    this.FireForm.get("BusinessCoverValuableContents").value();
    this.FireForm.get("other_contents").value();
    this.FireForm.get("stock").value();
    this.FireForm.get("total").value();
    this.FireForm.get("total").value();
