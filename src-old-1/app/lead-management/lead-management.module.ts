...
@NgModule({
  declarations: [TransferLeadComponent, ViewManagerLeadsComponent, ViewRmLeadsComponent, CallProgressComponent, AddLeadsComponent, AddExcelLeadaComponent, LmsReportComponent, LmsDashboardComponent, ExtraLeadsComponent,CampaignViewComponent, CampaignLogsComponent, PolicyWiseDetailsAgentComponent],
  imports: [
    MatPaginatorModule,
    CommonModule,
  ...
  entryComponents: [TransferLeadComponent, CallProgressComponent,AddLeadsComponent,AddExcelLeadaComponent,CampaignLogsComponent,PolicyWiseDetailsAgentComponent],
